...
import { LayoutDashboard, Calendar, TrendingUp, User, ShoppingBag, BookOpen } from 'lucide-react';
...
export function StudentLayout() {
  ...
  const links = [
      ...
      { to: "/student/book", icon: <BookOpen size={20} />, label: "Reservar Clase" },
      { to: "/student/bookings", icon: <Calendar size={20} />, label: "Mis Clases" },
      { to: "/student/payments", icon: <ShoppingBag size={20} />, label: "Packs y Pagos" },
